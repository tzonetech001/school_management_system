...
(7, 'Boarding Supervisor', 'Responsible for dormitories'),
...
CREATE TABLE `attendance_records` (
  ...
  `status` enum('present','absent','permission') DEFAULT NULL,
...
INSERT INTO `attendance_records` (`id`, `student_id`, `teacher_id`, `class_level`, `combination`, `attendance_date`, `day_of_week`, `status`, `remarks`, `recorded_at`, `updated_at`, `school_id`) VALUES
(15, 9, 32, 'Form Five', 'HGE', '2026-06-23', 'TU', 'absent', NULL, '2026-06-23 08:14:21', '2026-06-23 08:14:21', 1),
(16, 18, 32, 'Form Five', 'HGE', '2026-06-23', 'TU', 'present', NULL, '2026-06-23 08:14:21', '2026-06-23 08:14:21', 1),
(17, 69, 32, 'Form Five', 'HGE', '2026-06-23', 'TU', 'present', NULL, '2026-06-23 08:14:21', '2026-06-23 08:14:21', 1),
(18, 189, 32, 'Form Five', 'HGE', '2026-06-23', 'TU', 'permission', NULL, '2026-06-23 08:14:21', '2026-06-23 08:14:21', 1),
(22, 20, 32, 'Form Six', 'HGL', '2026-06-23', 'TU', 'present', NULL, '2026-06-23 08:16:14', '2026-06-23 08:16:14', 1),
(23, 28, 32, 'Form Six', 'HGL', '2026-06-23', 'TU', 'present', NULL, '2026-06-23 08:16:14', '2026-06-23 08:16:14', 1);
...
CREATE TABLE `fee_settings` (
  ...
  `total_fee` decimal(10,2) NOT NULL DEFAULT 0.00 COMMENT 'Total annual school fee',
  `term_1` decimal(10,2) NOT NULL DEFAULT 0.00,
  `term_2` decimal(10,2) NOT NULL DEFAULT 0.00,
  `term_3` decimal(10,2) NOT NULL DEFAULT 0.00,
  `updated_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `fee_settings` (`id`, `school_id`, `academic_year`, `total_fee`, `term_1`, `term_2`, `term_3`, `updated_by`, `updated_at`) VALUES
(1, 1, '2026/2027', 1500000.00, 750000.00, 750000.00, 0.00, 32, '2026-06-21 09:22:39');
...
INSERT INTO `forms` (`id`, `form_name`, `stream`, `created_at`) VALUES
(1, 'Form 1', '', '2026-06-10 16:15:23'),
(2, 'Form 2', '', '2026-06-10 16:15:23'),
(3, 'Form 3', '', '2026-06-10 16:15:23'),
(4, 'Form 4', '', '2026-06-10 16:15:23'),
(5, 'Form 5', '', '2026-06-10 16:15:23'),
(6, 'Form 6', '', '2026-06-10 16:15:23');
...
(114, 237, 20, 77, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 77.00, NULL, 35, '2026-06-22 17:27:43', '2026-06-22 17:27:44', NULL, 1);
...
--
-- Table structure for table `generated_timetables`
--
...
CREATE TABLE `holiday_packages` (
  ...
  `sent_to_app` tinyint(1) DEFAULT 0,
...
INSERT INTO `holiday_packages` (`id`, `subject`, `form_level`, `file_name`, `file_path`, `uploaded_by`, `uploaded_at`, `sent_to_app`, `package_description`) VALUES
(1, 'eco', 'Form Five', 'DIP.docx', 'uploads/holiday/6a385bcbd79bb_1782078411.docx', 35, '2026-06-21 21:46:52', 0, '');
...
INSERT INTO `learning_materials` (`id`, `subject`, `form_level`, `file_name`, `file_path`, `file_type`, `uploaded_by`, `uploaded_at`, `description`) VALUES
(1, 'test', 'Form Five', 'DIP.docx', 'uploads/materials/test_1782074059_DIP.docx', 'application/vnd.openxmlformats-officedocument.word', 0, '2026-06-21 20:34:19', 'Test upload'),
(2, 'eco', 'Form Five', 'GPS-1.pptx', 'uploads/materials/6a385588ddc67_1782076808.pptx', 'application/vnd.openxmlformats-officedocument.pres', 35, '2026-06-21 21:20:09', ''),
(3, 'eco', 'Form Five', 'GPS-1.pptx', 'uploads/materials/6a3855a289139_1782076834.pptx', 'application/vnd.openxmlformats-officedocument.pres', 35, '2026-06-21 21:20:34', ''),
(4, 'eco', 'Form Five', 'PROJECT PROPOSAL.pptx', 'uploads/materials/6a3855c7e8210_1782076871.pptx', 'application/vnd.openxmlformats-officedocument.pres', 35, '2026-06-21 21:21:11', '');
...
(26, 4, 'assignment', 'staff', 15, 12, 'Assigned c45 (chair) to staff: aujenia leo', '2026-02-09 17:54:02', 1, NULL),
(27, 2, 'return', 'student', 18, 12, 'Force returned c44 from student: JANETH WECH by admin', '2026-02-09 17:57:05', 1, NULL),
(28, 1, 'return', 'student', 18, 12, 'Returned t556 from student: JANETH WECH. Condition: good', '2026-02-09 17:57:27', 1, NULL),
(29, 5, 'return', 'staff', 15, 12, 'Returned t557 from staff: aujenia leo. Condition: good', '2026-02-09 17:57:33', 1, NULL),
(30, 4, 'return', 'staff', 15, 12, 'Returned c45 from staff: aujenia leo. Condition: good', '2026-02-09 17:57:35', 1, NULL),
(31, 1, 'assignment', 'student', 246, 12, 'Assigned t556 (table) to student: Samuel Mkumbo', '2026-03-08 02:35:00', 1, NULL),
(32, 2, 'assignment', 'student', 246, 12, 'Assigned c44 (chair) to student: Samuel Mkumbo', '2026-03-08 02:35:00', 1, NULL),
(33, 2, 'return', 'student', 246, 12, 'Returned c44 from student: Samuel Mkumbo. Condition: good', '2026-03-08 02:37:06', 1, NULL),
(34, 1, 'return', 'student', 246, 12, 'Returned t556 from student: Samuel Mkumbo. Condition: good', '2026-03-08 02:37:27', 1, NULL),
(35, 1, 'assignment', 'student', 246, 12, 'Assigned t556 (table) to student: Samuel Mkumbo', '2026-03-08 02:38:15', 1, NULL),
(36, 2, 'assignment', 'student', 246, 12, 'Assigned c44 (chair) to student: Samuel Mkumbo', '2026-03-08 02:38:15', 1, NULL),
(37, 1, 'return', 'student', 246, 12, 'Returned t556 from student: Samuel Mkumbo. Condition: good', '2026-03-08 02:38:40', 1, NULL),
(38, 2, 'return', 'student', 246, 12, 'Returned c44 from student: Samuel Mkumbo. Condition: good', '2026-03-08 02:38:43', 1, NULL),
(39, 1, 'assignment', 'student', 409, 32, 'Assigned t556 (table) to student: princess toy', '2026-04-21 18:26:58', 1, NULL),
(40, 2, 'assignment', 'student', 409, 32, 'Assigned c44 (chair) to student: princess toy', '2026-04-21 18:26:58', 1, NULL),
...
(9, 41, 5, 'table', 32, '2026-06-23', '2026-06-23', 'active', NULL, NULL, NULL, '', '2026-06-23 10:04:42', '2026-06-23 10:04:42', 1),
(10, 41, 4, 'chair', 32, '2026-06-23', '2026-06-23', 'active', NULL, NULL, NULL, '', '2026-06-23 10:04:42', '2026-06-23 10:04:42', 1);
...
(1, 'S1280', 'UBUNGO HIGH SCHOOL', 'Education For Life', 'uploads/school_logos/school_1_S1280_1782205185.jpg', '', '0714343162', '', 'Active', '2026-06-02 08:43:38', '2026-06-23 08:59:45', '{\"primary\":\"#3B9DB3\",\"primary_dark\":\"#2d7c8f\",\"primary_light\":\"#8bc5d6\",\"text\":\"#333333\",\"text_light\":\"#666666\",\"border\":\"#e0e0e0\",\"success\":\"#28a745\",\"danger\":\"#dc3545\",\"warning\":\"#ffc107\",\"info\":\"#17a2b8\",\"coral\":\"#FF7F50\",\"forest_green\":\"#2E7D32\",\"lime_green\":\"#63E07E\",\"sky_blue\":\"#66d9ff\",\"aqua_blue\":\"#4dd2ff\"}', '{\"sidebar_collapsed\":\"0\",\"font_size\":\"16\",\"animations\":\"1\",\"compact_mode\":\"0\",\"background_opacity\":\"65\",\"background_option\":\"image\",\"animation_speed\":\"normal\"}', '{\"theme\":true,\"preferences\":true}'),
(2, 'S1047', 'MABIBO HIGH SCHOOL', 'Education is the key of life', 'uploads/school_logos/school_2_S1047_1782205171.jpg', 'dar', '0765432123', 'kfwekrle@gmail.com', 'Active', '2026-06-02 10:58:55', '2026-06-23 08:59:31', NULL, NULL, NULL);
...
CREATE TABLE `students` (
  ...
  `teacher_short_note` text DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `students` (`id`, `index_number`, `first_name`, `second_name`, `last_name`, `sex`, `combination`, `date_of_birth`, `date_of_admission`, `admission_number`, `class`, `citizenship`, `place_of_birth`, `parent_name`, `parent_phone`, `password`, `parent_occupation`, `parent_residence`, `former_school`, `school_transferred_to`, `date_leaving_school`, `school_transferred_from`, `status`, `created_at`, `updated_at`, `is_leaver`, `year_left`, `previous_class`, `class_changed_at`, `is_returned`, `graduation_status`, `graduation_year`, `promotion_status`, `updated_by_admin`, `failed_login_attempts`, `locked_until`, `last_login_attempt`, `profile_image`, `school_id`, `academic_year`, `teacher_short_note`) VALUES
(1, 'S1280-0508', 'Jackson', 'Ayubu', 'Mwalongo', 'Male', 'HGE', '2026-06-10', '2026-06-10', 'S0964/0076/2026', 'Form Five', 'Tanzania', 'Dar', 'Ayubu Mwalongo', '255764275301', '$2y$10$qdvdaofx4Fj6HPZ0KQZXS.lg7TYs2hn/sLlcNP68.cnObtLNCGSHe', 'mkulima', 'ubungo', '', '', NULL, '', 1, '2026-06-10 20:49:36', '2026-06-22 17:51:28', 0, NULL, NULL, NULL, 0, 'Active', NULL, 'Not Promoted', NULL, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(7, 'S1280-0563', 'jamary', 'hello', 'smith', 'Male', 'EGM', '2026-01-06', '2026-01-06', '1234678', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '0745657855', '$2y$10$YourDefaultHashHere', 'MKULIMA', 'KIGOMA', '', '', NULL, '', 1, '2026-01-06 05:17:36', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(9, 'S1280-0502', 'juju', 'juma', 'yusla', 'Female', 'HGE', '2026-01-06', '2026-01-06', '16589', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657567', '$2y$10$YourDefaultHashHere', 'MKULIMA', 'KIGOMA', '', '', NULL, '', 1, '2026-01-06 05:52:24', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(10, 'S1280-0549', 'jamary', 'JUMANNE ', 'mussa', 'Male', 'KLF', '2026-01-02', '2026-01-06', '6788', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657590', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', '', '', '0000-00-00', '', 1, '2026-01-06 07:45:52', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(11, 'S1280-0533', 'alu', 'JUMANNE ', 'mussa', 'Female', 'HKL', '2026-01-13', '2026-01-06', '877', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657983', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', '', '', '0000-00-00', '', 1, '2026-01-06 07:46:57', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(13, 'S1280-0515', 'halima', 'JUMANNE ', 'mussa', 'Female', 'HGL', '2025-12-30', '2026-01-06', '12345455', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657444', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', '', '', '0000-00-00', '', 1, '2026-01-06 08:41:30', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(14, 'S1280-0524', 'aujenia', 'JUMANNE ', 'TADEO', 'Female', 'HGK', '2025-12-30', '2026-01-06', '126677', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657888', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', '', '', '0000-00-00', '', 1, '2026-01-06 08:47:28', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(15, 'S1280-0576', 'franc', 'peter', 'leo', 'Male', 'HGF', '2020-06-06', '2026-01-06', '456782', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745657765', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', 'nysrubanda', 'nyarubanda', '2026-01-06', 'muyovozi', 1, '2026-01-06 10:06:00', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(17, 'S1280-0559', 'THAZAN', 'JUMANNE ', 'TZONE', 'Male', 'HLF', '1999-02-08', '2026-01-08', '12348', 'Form Six', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255746457688', '$2y$10$YourDefaultHashHere', 'mkulima', 'KIGOMA', 'nyArubanda s1270/0114/2025', 'nyarubanda', '2026-01-08', 'muyovozi', 1, '2026-01-08 07:51:11', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(18, 'S1280-0501', 'JANETH', 'SAMSON', 'WECH', 'Female', 'HGE', '2005-07-13', '2026-01-08', '01', 'Form Five', 'Tanzania', 'KIGOMA', 'JAMARY TOPHIC', '255714343162', '$2y$10$JAImSSwHLvSjJiFkG11yyO7VUh1UaTJGdqhKl78oCX3r5RScUJ.ha', 'mkulima', 'KIGOMA', '', '', NULL, '', 1, '2026-01-08 08:07:52', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 2, NULL, '2026-03-11 12:22:26', NULL, 1, '2025/2026', NULL),
(20, 'S1280-0506', 'Grace', 'John', 'Mkenda', 'Female', 'HGL', '2005-07-22', '2023-01-10', 'ADM002F', 'Form Six', 'Tanzania', 'Arusha', 'John Mkenda', '0755123456', '$2y$10$YourDefaultHashHere', 'Farmer', 'Arusha Municipality', 'Arusha Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(21, 'S1280-0513', 'Asha', 'Ali', 'Juma', 'Female', 'HGK', '2005-11-05', '2023-01-10', 'ADM003F', 'Form Six', 'Tanzania', 'Zanzibar', 'Ali Juma', '0777345678', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Stone Town, Zanzibar', 'Zanzibar Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(22, 'S1280-0525', 'Fatuma', 'Ramadhani', 'Hassan', 'Female', 'HKL', '2005-01-30', '2023-01-10', 'ADM004F', 'Form Six', 'Tanzania', 'Tanga', 'Ramadhani Hassan', '0765123456', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(23, 'S1280-0533', 'Aisha', 'Mohamed', 'Said', 'Female', 'KLF', '2005-09-14', '2023-01-10', 'ADM005F', 'Form Six', 'Tanzania', 'Mwanza', 'Mohamed Said', '0789345678', '$2y$10$YourDefaultHashHere', 'Doctor', 'Ilemela, Mwanza', 'Mwanza Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(24, 'S1280-0543', 'Zainab', 'Salim', 'Abdallah', 'Female', 'EGM', '2005-04-18', '2023-01-10', 'ADM006F', 'Form Six', 'Tanzania', 'Dodoma', 'Salim Abdallah', '0711123456', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(25, 'S1280-0550', 'Mariam', 'Yusuf', 'Khamis', 'Female', 'HLF', '2005-12-25', '2023-01-10', 'ADM007F', 'Form Six', 'Tanzania', 'Mbeya', 'Yusuf Khamis', '0756123456', '$2y$10$YourDefaultHashHere', 'Engineer', 'Mbeya City', 'Mbeya Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(26, 'S1280-0560', 'Happiness', 'Paul', 'Mpenda', 'Female', 'HGF', '2005-06-08', '2023-01-10', 'ADM008F', 'Form Six', 'Tanzania', 'Morogoro', 'Paul Mpenda', '0777123456', '$2y$10$YourDefaultHashHere', 'Teacher', 'Morogoro Municipality', 'Morogoro Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(27, 'S1280-0502', 'Sarah', 'David', 'Mbowe', 'Female', 'HGE', '2005-08-19', '2023-01-10', '0001', 'Form Six', 'Tanzania', 'Dar es Salaam', 'David Mbowe', '255712345679', '$2y$10$6kf4tTAXDwL2CauJTzUmiuaNrVPUKX8NbV.T8GbtoufAiXa1SfJHC', 'Businessman', 'Ilala, Dar es Salaam', 'Azania Secondary', 'muyo', '0000-00-00', '', 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, '2026-03-11 12:02:44', NULL, 1, '2025/2026', NULL),
(28, 'S1280-0505', 'Catherine', 'Peter', 'Kibona', 'Female', 'HGL', '2005-02-11', '2023-01-10', 'ADM010F', 'Form Six', 'Tanzania', 'Moshi', 'Peter Kibona', '255619844080', '$2y$10$2FJu.SJ1Lpan6vx9lvN0pOsSLnlJQiWS8jbiJdYTA8olRV/Pi7dEe', 'Hotel Manager', 'Moshi Municipality', 'Moshi Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(31, 'S1280-0520', 'David', 'Jacob', 'Mwingira', 'Male', 'HGK', '2005-03-25', '2023-01-10', 'ADM013M', 'Form Six', 'Tanzania', 'Dodoma', 'Jacob Mwingira', '0777345680', '$2y$10$YourDefaultHashHere', 'Farmer', 'Dodoma Rural', 'Dodoma Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(32, 'S1280-0530', 'James', 'Thomas', 'Kapinga', 'Male', 'HKL', '2005-07-30', '2023-01-10', 'ADM014M', 'Form Six', 'Tanzania', 'Mwanza', 'Thomas Kapinga', '0765123457', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Mwanza City', 'Mwanza Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(33, 'S1280-0538', 'Peter', 'Andrew', 'Nyanda', 'Male', 'KLF', '2005-11-15', '2023-01-10', 'ADM015M', 'Form Six', 'Tanzania', 'Mbeya', 'Andrew Nyanda', '0789345680', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(34, 'S1280-0545', 'Michael', 'Christopher', 'Mpemba', 'Male', 'EGM', '2005-01-22', '2023-01-10', 'ADM016M', 'Form Six', 'Tanzania', 'Tanga', 'Christopher Mpemba', '0711123457', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(35, 'S1280-0558', 'Simon', 'Gabriel', 'Kisare', 'Male', 'HLF', '2005-09-05', '2023-01-10', 'ADM017M', 'Form Six', 'Tanzania', 'Morogoro', 'Gabriel Kisare', '0756123457', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Morogoro Municipality', 'Morogoro Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(36, 'S1280-0570', 'Paul', 'Matthew', 'Mtonga', 'Male', 'HGF', '2005-04-28', '2023-01-10', 'ADM018M', 'Form Six', 'Tanzania', 'Dar es Salaam', 'Matthew Mtonga', '0777123457', '$2y$10$YourDefaultHashHere', 'Doctor', 'Temeke, Dar es Salaam', 'Temeke Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(38, 'S1280-0510', 'Luke', 'Barnabas', 'Mosha', 'Male', 'HGL', '2005-12-10', '2023-01-10', 'ADM020M', 'Form Six', 'Tanzania', 'Moshi', 'Barnabas Mosha', '0755123459', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(39, 'S1280-0527', 'Rehema', 'Juma', 'Kondo', 'Female', 'HGK', '2004-03-15', '2022-01-10', 'ADM021F', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Juma Kondo', '0712345682', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Kinondoni, Dar es Salaam', 'Kisutu Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(40, 'S1280-0538', 'Pendo', 'Rajabu', 'Mloka', 'Female', 'HKL', '2004-07-22', '2022-01-10', 'ADM022F', 'Form Five', 'Tanzania', 'Zanzibar', 'Rajabu Mloka', '0755123460', '$2y$10$YourDefaultHashHere', 'Teacher', 'Stone Town, Zanzibar', 'Zanzibar Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(41, 'S1280-0548', 'Tumaini', 'Salum', 'Kibwana', 'Female', 'KLF', '2004-11-05', '2022-01-10', 'ADM023F', 'Form Five', 'Tanzania', 'Tanga', 'Salum Kibwana', '0777345682', '$2y$10$YourDefaultHashHere', 'Nurse', 'Tanga City', 'Tanga Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(42, 'S1280-0555', 'Furaha', 'Hamisi', 'Mwakyembe', 'Female', 'EGM', '2004-01-30', '2022-01-10', 'ADM024F', 'Form Five', 'Tanzania', 'Mwanza', 'Hamisi Mwakyembe', '0765123458', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ilemela, Mwanza', 'Mwanza Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(43, 'S1280-0568', 'Upendo', 'Issa', 'Kamala', 'Female', 'HLF', '2004-09-14', '2022-01-10', 'ADM025F', 'Form Five', 'Tanzania', 'Dodoma', 'Issa Kamala', '0789345682', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(44, 'S1280-0575', 'Imani', 'Suleiman', 'Mkumbo', 'Female', 'HGF', '2004-04-18', '2022-01-10', 'ADM026F', 'Form Five', 'Tanzania', 'Mbeya', 'Suleiman Mkumbo', '0711123458', '$2y$10$YourDefaultHashHere', 'Doctor', 'Mbeya City', 'Mbeya Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(46, 'S1280-0516', 'Mama', 'Yahya', 'Kadanya', 'Female', 'HGL', '2004-06-08', '2022-01-10', 'ADM028F', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Yahya Kadanya', '0777123458', '$2y$10$YourDefaultHashHere', 'Businessman', 'Ilala, Dar es Salaam', 'Azania Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(47, 'S1280-0525', 'Dada', 'Kassim', 'Mgeni', 'Female', 'HGK', '2004-08-19', '2022-01-10', 'ADM029F', 'Form Five', 'Tanzania', 'Arusha', 'Kassim Mgeni', '0712345683', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha Municipality', 'Arusha Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(48, 'S1280-0536', 'Mtoto', 'Hassan', 'Mwinyi', 'Female', 'HKL', '2004-02-11', '2022-01-10', 'ADM030F', 'Form Five', 'Tanzania', 'Moshi', 'Hassan Mwinyi', '0755123461', '$2y$10$YourDefaultHashHere', 'Hotel Manager', 'Moshi Municipality', 'Moshi Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(49, 'S1280-0552', 'Rajabu', 'Abdallah', 'Mfugale', 'Male', 'KLF', '2004-05-20', '2022-01-10', 'ADM031M', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Abdallah Mfugale', '0712345684', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ubungo, Dar es Salaam', 'Kisutu Boys Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(50, 'S1280-0561', 'Hamisi', 'Juma', 'Kivuyo', 'Male', 'EGM', '2004-10-12', '2022-01-10', 'ADM032M', 'Form Five', 'Tanzania', 'Arusha', 'Juma Kivuyo', '0755123462', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha City', 'Arusha Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(51, 'S1280-0570', 'Kassim', 'Salim', 'Mkwizu', 'Male', 'HLF', '2004-03-25', '2022-01-10', 'ADM033M', 'Form Five', 'Tanzania', 'Dodoma', 'Salim Mkwizu', '0777345684', '$2y$10$YourDefaultHashHere', 'Farmer', 'Dodoma Rural', 'Dodoma Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(52, 'S1280-0579', 'Suleiman', 'Omar', 'Kijaji', 'Male', 'HGF', '2004-07-30', '2022-01-10', 'ADM034M', 'Form Five', 'Tanzania', 'Mwanza', 'Omar Kijaji', '0765123459', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Mwanza City', 'Mwanza Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(53, 'S1280-0512', 'Yusuf', 'Ali', 'Mtei', 'Male', 'HGE', '2004-11-15', '2022-01-10', 'ADM035M', 'Form Five', 'Tanzania', 'Mbeya', 'Ali Mtei', '0789345684', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(54, 'S1280-0518', 'Ali', 'Mohamed', 'Mushi', 'Male', 'HGL', '2004-01-22', '2022-01-10', 'ADM036M', 'Form Five', 'Tanzania', 'Tanga', 'Mohamed Mushi', '0711123459', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(55, 'S1280-0531', 'Mohamed', 'Rashid', 'Kibwana', 'Male', 'HGK', '2004-09-05', '2022-01-10', 'ADM037M', 'Form Five', 'Tanzania', 'Morogoro', 'Rashid Kibwana', '0756123459', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Morogoro Municipality', 'Morogoro Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(56, 'S1280-0542', 'Rashid', 'Saidi', 'Mtemvu', 'Male', 'HKL', '2004-04-28', '2022-01-10', 'ADM038M', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Saidi Mtemvu', '0777123459', '$2y$10$YourDefaultHashHere', 'Doctor', 'Temeke, Dar es Salaam', 'Temeke Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(57, 'S1280-0553', 'Saidi', 'Hemed', 'Kavishe', 'Male', 'KLF', '2004-08-03', '2022-01-10', 'ADM039M', 'Form Five', 'Tanzania', 'Arusha', 'Hemed Kavishe', '0712345685', '$2y$10$YourDefaultHashHere', 'Tour Operator', 'Arusha City', 'Arusha Modern Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(58, 'S1280-0562', 'Hemed', 'Mzee', 'Mariki', 'Male', 'EGM', '2004-12-10', '2022-01-10', 'ADM040M', 'Form Five', 'Tanzania', 'Moshi', 'Mzee Mariki', '0755123463', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(59, 'S1280-0549', 'Halima', 'Seif', 'Kishimbo', 'Female', 'HLF', '2005-03-08', '2023-01-10', 'ADM041F', 'Form Six', 'Tanzania', 'Lindi', 'Seif Kishimbo', '0712345686', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Lindi Town', 'Lindi Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(60, 'S1280-0563', 'Zuhura', 'Athumani', 'Mwambene', 'Female', 'HGF', '2005-06-21', '2023-01-10', 'ADM042F', 'Form Six', 'Tanzania', 'Mtwara', 'Athumani Mwambene', '0755123464', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mtwara Mikindani', 'Mtwara Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(61, 'S1280-0506', 'Mwanahawa', 'Hassani', 'Kitwana', 'Female', 'HGE', '2005-10-04', '2023-01-10', 'ADM043F', 'Form Five', 'Tanzania', 'Pwani', 'Hassani Kitwana', '255777345686', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Kibaha', 'Pwani Girls Secondary', '', '0000-00-00', '', 1, '2026-01-08 12:34:32', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(62, 'S1280-0507', 'Khadija', 'Jafari', 'Mpango', 'Female', 'HGL', '2005-01-17', '2023-01-10', 'ADM044F', 'Form Six', 'Tanzania', 'Ruvuma', 'Jafari Mpango', '0765123460', '$2y$10$YourDefaultHashHere', 'Farmer', 'Songea', 'Ruvuma Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(63, 'S1280-0518', 'Sauda', 'Mwinyimkuu', 'Kibiriti', 'Female', 'HGK', '2005-07-29', '2023-01-10', 'ADM045F', 'Form Six', 'Tanzania', 'Shinyanga', 'Mwinyimkuu Kibiriti', '0789345686', '$2y$10$YourDefaultHashHere', 'Miner', 'Shinyanga Town', 'Shinyanga Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(64, 'S1280-0527', 'Bakari', 'Mwinyi', 'Mwandu', 'Male', 'HKL', '2005-04-12', '2023-01-10', 'ADM046M', 'Form Six', 'Tanzania', 'Kagera', 'Mwinyi Mwandu', '0711123460', '$2y$10$YourDefaultHashHere', 'Businessman', 'Bukoba', 'Kagera Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(65, 'S1280-0551', 'Juma', 'Makame', 'Kisanga', 'Male', 'KLF', '2005-09-24', '2023-01-10', 'ADM047M', 'Form Five', 'Tanzania', 'Mara', 'Makame Kisanga', '0756123460', '$2y$10$YourDefaultHashHere', 'Teacher', 'Musoma', 'Mara Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(66, 'S1280-0546', 'Ramadhani', 'Mzee', 'Kibanda', 'Male', 'EGM', '2005-12-07', '2023-01-10', 'ADM048M', 'Form Six', 'Tanzania', 'Manyara', 'Mzee Kibanda', '0777123460', '$2y$10$YourDefaultHashHere', 'Farmer', 'Babati', 'Manyara Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(67, 'S1280-0555', 'Mwinyi', 'Kondo', 'Msangi', 'Male', 'HLF', '2005-05-19', '2023-01-10', 'ADM049M', 'Form Six', 'Tanzania', 'Geita', 'Kondo Msangi', '0712345687', '$2y$10$YourDefaultHashHere', 'Miner', 'Geita Town', 'Geita Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(68, 'S1280-0567', 'Makame', 'Hussein', 'Kijiko', 'Male', 'HGF', '2005-08-01', '2023-01-10', 'ADM050M', 'Form Six', 'Tanzania', 'Simiyu', 'Hussein Kijiko', '0755123465', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Bariadi', 'Simiyu Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(69, 'S1280-0504', 'Maimuna', 'Khamis', 'Mkubwa', 'Female', 'HGE', '2004-02-14', '2022-01-10', 'ADM051F', 'Form Five', 'Tanzania', 'Katavi', 'Khamis Mkubwa', '0777345687', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Mpanda', 'Katavi Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(70, 'S1280-0517', 'Mwanajuma', 'Sadiki', 'Kibao', 'Female', 'HGL', '2004-05-27', '2022-01-10', 'ADM052F', 'Form Five', 'Tanzania', 'Njombe', 'Sadiki Kibao', '0765123461', '$2y$10$YourDefaultHashHere', 'Teacher', 'Njombe Town', 'Njombe Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(71, 'S1280-0528', 'Tabu', 'Mzee', 'Kikwete', 'Female', 'HGK', '2004-09-09', '2022-01-10', 'ADM053F', 'Form Five', 'Tanzania', 'Kigoma', 'Mzee Kikwete', '0789345687', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Kigoma Ujiji', 'Kigoma Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(72, 'S1280-0537', 'Mwajuma', 'Hamad', 'Kibona', 'Female', 'HKL', '2004-12-22', '2022-01-10', 'ADM054F', 'Form Five', 'Tanzania', 'Rukwa', 'Hamad Kibona', '0711123461', '$2y$10$YourDefaultHashHere', 'Farmer', 'Sumbawanga', 'Rukwa Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(73, 'S1280-0545', 'Jamila', 'Abdul', 'Mteule', 'Female', 'KLF', '2004-03-06', '2022-01-10', 'ADM055F', 'Form Five', 'Tanzania', 'Pemba', 'Abdul Mteule', '0756123461', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Chake Chake', 'Pemba Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(74, 'S1280-0558', 'Abdallah', 'Kombo', 'Mpemba', 'Male', 'EGM', '2004-06-19', '2022-01-10', 'ADM056M', 'Form Five', 'Tanzania', 'Unguja', 'Kombo Mpemba', '0777123461', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Zanzibar Town', 'Unguja Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(75, 'S1280-0571', 'Kombo', 'Kondo', 'Kiwia', 'Male', 'HLF', '2004-10-02', '2022-01-10', 'ADM057M', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Kondo Kiwia', '0712345688', '$2y$10$YourDefaultHashHere', 'Engineer', 'Kigamboni, Dar es Salaam', 'Kigamboni Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(76, 'S1280-0578', 'Kondo', 'Mzee', 'Kilonzo', 'Male', 'HGF', '2004-01-15', '2022-01-10', 'ADM058M', 'Form Five', 'Tanzania', 'Arusha', 'Mzee Kilonzo', '0755123466', '$2y$10$YourDefaultHashHere', 'Tour Operator', 'Arusha City', 'Arusha Technical Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(78, 'S1280-0523', 'Massawe', 'Chamwela', 'Kimario', 'Male', 'HGL', '2004-08-11', '2022-01-10', 'ADM060M', 'Form Five', 'Tanzania', 'Dodoma', 'Chamwela Kimario', '0765123462', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Technical Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(79, 'S1280-0515', 'Ester', 'Daudi', 'Minja', 'Female', 'HGK', '2005-11-24', '2023-01-10', 'ADM061F', 'Form Six', 'Tanzania', 'Mbeya', 'Daudi Minja', '0789345688', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Technical Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(81, 'S1280-0536', 'Ruth', 'Yuda', 'Mwalukasa', 'Female', 'KLF', '2005-06-20', '2023-01-10', 'ADM063F', 'Form Six', 'Tanzania', 'Morogoro', 'Yuda Mwalukasa', '0756123462', '$2y$10$YourDefaultHashHere', 'Doctor', 'Morogoro Municipality', 'Morogoro Technical Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(82, 'S1280-0541', 'Naomi', 'Naftali', 'Mwakalinga', 'Female', 'EGM', '2005-10-03', '2023-01-10', 'ADM064F', 'Form Six', 'Tanzania', 'Mwanza', 'Naftali Mwakalinga', '0777123462', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ilemela, Mwanza', 'Mwanza Technical Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(83, 'S1280-0551', 'Rachel', 'Joshua', 'Mtepa', 'Female', 'HLF', '2005-01-16', '2023-01-10', 'ADM065F', 'Form Six', 'Tanzania', 'Arusha', 'Joshua Mtepa', '0712345689', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha City', 'Arusha Technical Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(84, 'S1280-0564', 'Elia', 'Samson', 'Mkumbo', 'Male', 'HGF', '2005-04-29', '2023-01-10', 'ADM066M', 'Form Six', 'Tanzania', 'Moshi', 'Samson Mkumbo', '0755123467', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Technical Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(85, 'S1280-0511', 'Samson', 'Daniel', 'Mlinga', 'Male', 'HGE', '2005-08-12', '2023-01-10', 'ADM067M', 'Form Five', 'Tanzania', 'Kinondoni, Dar es Salaam', 'Daniel Mlinga', '0777345689', '$2y$10$YourDefaultHashHere', 'Businessman', 'Kinondoni, Dar es Salaam', 'Kinondoni Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(87, 'S1280-0522', 'Nathan', 'Isaac', 'Mkama', 'Male', 'HGK', '2005-03-09', '2023-01-10', 'ADM069M', 'Form Six', 'Tanzania', 'Tanga', 'Isaac Mkama', '0789345689', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tanga City', 'Tanga Technical Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(88, 'S1280-0529', 'Isaac', 'Abraham', 'Mkwawa', 'Male', 'HKL', '2005-06-22', '2023-01-10', 'ADM070M', 'Form Six', 'Tanzania', 'Iringa', 'Abraham Mkwawa', '0711123463', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Iringa Municipality', 'Iringa Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(89, 'S1280-0546', 'Lydia', 'Zakaria', 'Mabula', 'Female', 'KLF', '2004-10-05', '2022-01-10', 'ADM071F', 'Form Five', 'Tanzania', 'Songwe', 'Zakaria Mabula', '0756123463', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Vwawa', 'Songwe Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(90, 'S1280-0556', 'Miriam', 'Hosea', 'Mgimwa', 'Female', 'EGM', '2004-01-18', '2022-01-10', 'ADM072F', 'Form Five', 'Tanzania', 'Tabora', 'Hosea Mgimwa', '0777123463', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tabora Municipality', 'Tabora Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(91, 'S1280-0566', 'Hannah', 'Amos', 'Mwakalukwa', 'Female', 'HLF', '2004-05-01', '2022-01-10', 'ADM073F', 'Form Five', 'Tanzania', 'Singida', 'Amos Mwakalukwa', '0712345690', '$2y$10$YourDefaultHashHere', 'Nurse', 'Singida Town', 'Singida Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(92, 'S1280-0573', 'Elizabeth', 'Jeremiah', 'Mfupi', 'Female', 'HGF', '2004-08-14', '2022-01-10', 'ADM074F', 'Form Five', 'Tanzania', 'Mara', 'Jeremiah Mfupi', '0755123468', '$2y$10$YourDefaultHashHere', 'Doctor', 'Musoma', 'Mara Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(93, 'S1280-0505', 'Mary', 'Ezekiel', 'Mkumbo', 'Female', 'HGE', '2004-11-27', '2022-01-10', 'ADM075F', 'Form Five', 'Tanzania', 'Kagera', 'Ezekiel Mkumbo', '0777345690', '$2y$10$YourDefaultHashHere', 'Engineer', 'Bukoba', 'Kagera Girls Secondary', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(94, 'S1280-0522', 'Ezekiel', 'Isaiah', 'Mnyampala', 'Male', 'HGL', '2004-03-11', '2022-01-10', 'ADM076M', 'Form Five', 'Tanzania', 'Shinyanga', 'Isaiah Mnyampala', '0765123464', '$2y$10$YourDefaultHashHere', 'Miner', 'Shinyanga Town', 'Shinyanga Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(95, 'S1280-0530', 'Isaiah', 'Malachi', 'Mwakipesile', 'Male', 'HGK', '2004-06-24', '2022-01-10', 'ADM077M', 'Form Five', 'Tanzania', 'Geita', 'Malachi Mwakipesile', '0789345690', '$2y$10$YourDefaultHashHere', 'Miner', 'Geita Town', 'Geita Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(96, 'S1280-0541', 'Malachi', 'Jonah', 'Mwagike', 'Male', 'HKL', '2004-10-07', '2022-01-10', 'ADM078M', 'Form Five', 'Tanzania', 'Simiyu', 'Jonah Mwagike', '0711123464', '$2y$10$YourDefaultHashHere', 'Farmer', 'Bariadi', 'Simiyu Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(97, 'S1280-0550', 'Jonah', 'Obadiah', 'Mkude', 'Male', 'KLF', '2004-01-20', '2022-01-10', 'ADM079M', 'Form Five', 'Tanzania', 'Katavi', 'Obadiah Mkude', '0756123464', '$2y$10$YourDefaultHashHere', 'Businessman', 'Mpanda', 'Katavi Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(98, 'S1280-0564', 'Obadiah', 'Micah', 'Mwalongo', 'Male', 'EGM', '2004-05-03', '2022-01-10', 'ADM080M', 'Form Five', 'Tanzania', 'Njombe', 'Micah Mwalongo', '0777123464', '$2y$10$YourDefaultHashHere', 'Teacher', 'Njombe Town', 'Njombe Technical', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(179, 'S1280-0552', 'Rose', 'Moses', 'Mwandosya', 'Female', 'HLF', '2005-09-16', '2023-01-10', 'ADM081F', 'Form Six', 'Tanzania', 'Kigoma', 'Moses Mwandosya', '0712345691', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Kigoma Ujiji', 'Kigoma Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(180, 'S1280-0561', 'Joyce', 'Aaron', 'Mkenda', 'Female', 'HGF', '2005-12-29', '2023-01-10', 'ADM082F', 'Form Six', 'Tanzania', 'Rukwa', 'Aaron Mkenda', '0755123469', '$2y$10$YourDefaultHashHere', 'Farmer', 'Sumbawanga', 'Rukwa Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(182, 'S1280-0509', 'Teresia', 'Joshua', 'Mwangoka', 'Female', 'HGL', '2005-07-24', '2023-01-10', 'ADM084F', 'Form Six', 'Tanzania', 'Unguja', 'Joshua Mwangoka', '0765123465', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Zanzibar Town', 'Unguja Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(183, 'S1280-0514', 'Consolata', 'Benjamin', 'Mkude', 'Female', 'HGK', '2005-11-06', '2023-01-10', 'ADM085F', 'Form Six', 'Tanzania', 'Dar es Salaam', 'Benjamin Mkude', '0789345691', '$2y$10$YourDefaultHashHere', 'Engineer', 'Kigamboni', 'Kigamboni Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(184, 'S1280-0540', 'Benjamin', 'Samuel', 'Mwangosi', 'Male', 'HKL', '2005-02-19', '2023-01-10', 'ADM086M', 'Form Five', 'Tanzania', 'Arusha', 'Samuel Mwangosi', '255711123465', '$2y$10$YourDefaultHashHere', 'Tour Operator', 'Arusha City', 'Arusha Boys', '', '0000-00-00', '', 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(185, 'S1280-0539', 'Samuel', 'Solomon', 'Mkuchika', 'Male', 'KLF', '2005-06-02', '2023-01-10', 'ADM087M', 'Form Six', 'Tanzania', 'Moshi', 'Solomon Mkuchika', '0756123465', '$2y$10$YourDefaultHashHere', 'Hotel Manager', 'Moshi Rural', 'Moshi Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(186, 'S1280-0547', 'Solomon', 'Reuben', 'Mwaibula', 'Male', 'EGM', '2005-09-15', '2023-01-10', 'ADM088M', 'Form Six', 'Tanzania', 'Dodoma', 'Reuben Mwaibula', '0777123465', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(187, 'S1280-0556', 'Reuben', 'Levi', 'Mwinuka', 'Male', 'HLF', '2005-12-28', '2023-01-10', 'ADM089M', 'Form Six', 'Tanzania', 'Mbeya', 'Levi Mwinuka', '0712345692', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(188, 'S1280-0566', 'Levi', 'Judah', 'Mwakapalala', 'Male', 'HGF', '2005-04-10', '2023-01-10', 'ADM090M', 'Form Six', 'Tanzania', 'Tanga', 'Judah Mwakapalala', '0755123470', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(189, 'S1280-0503', 'Magdalena', 'Simeon', 'Mteule', 'Female', 'HGE', '2004-07-23', '2022-01-10', 'ADM091F', 'Form Five', 'Tanzania', 'Morogoro', 'Simeon Mteule', '0777345692', '$2y$10$YourDefaultHashHere', 'Doctor', 'Morogoro Municipality', 'Morogoro Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(190, 'S1280-0513', 'Agnes', 'Gad', 'Mkumbo', 'Female', 'HGL', '2004-11-05', '2022-01-10', 'ADM092F', 'Form Five', 'Tanzania', 'Mwanza', 'Gad Mkumbo', '0765123466', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ilemela, Mwanza', 'Mwanza Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(191, 'S1280-0529', 'Veronica', 'Asher', 'Mwagikana', 'Female', 'HGK', '2004-02-18', '2022-01-10', 'ADM093F', 'Form Five', 'Tanzania', 'Arusha', 'Asher Mwagikana', '0789345692', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha City', 'Arusha Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(192, 'S1280-0534', 'Christina', 'Naphtali', 'Mkumbo', 'Female', 'HKL', '2004-06-01', '2022-01-10', 'ADM094F', 'Form Five', 'Tanzania', 'Moshi', 'Naphtali Mkumbo', '0711123466', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(193, 'S1280-0547', 'Monica', 'Joseph', 'Mwakalukwa', 'Female', 'KLF', '2004-09-14', '2022-01-10', 'ADM095F', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Joseph Mwakalukwa', '0756123466', '$2y$10$YourDefaultHashHere', 'Businessman', 'Kinondoni', 'Kinondoni Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(194, 'S1280-0560', 'Gideon', 'Dan', 'Mkumbo', 'Male', 'EGM', '2004-12-27', '2022-01-10', 'ADM096M', 'Form Five', 'Tanzania', 'Zanzibar', 'Dan Mkumbo', '0777123466', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Stone Town', 'Zanzibar Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(195, 'S1280-0569', 'Dan', 'Zebulun', 'Mtepa', 'Male', 'HLF', '2004-04-09', '2022-01-10', 'ADM097M', 'Form Five', 'Tanzania', 'Tanga', 'Zebulun Mtepa', '0712345693', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tanga City', 'Tanga Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(196, 'S1280-0580', 'Zebulun', 'Issachar', 'Mwangoka', 'Male', 'HGF', '2004-07-22', '2022-01-10', 'ADM098M', 'Form Five', 'Tanzania', 'Iringa', 'Issachar Mwangoka', '0755123471', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Iringa Municipality', 'Iringa Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(198, 'S1280-0521', 'Ephraim', 'Manasseh', 'Mwakasaka', 'Male', 'HGL', '2004-02-17', '2022-01-10', 'ADM100M', 'Form Five', 'Tanzania', 'Tabora', 'Manasseh Mwakasaka', '0765123467', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tabora Municipality', 'Tabora Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(199, 'S1280-0516', 'Patricia', 'Ephraim', 'Mngumi', 'Female', 'HGK', '2005-05-31', '2023-01-10', 'ADM101F', 'Form Six', 'Tanzania', 'Singida', 'Ephraim Mngumi', '0789345693', '$2y$10$YourDefaultHashHere', 'Nurse', 'Singida Town', 'Singida Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(200, 'S1280-0524', 'Eunice', 'Manasseh', 'Mkumbo', 'Female', 'HKL', '2005-09-13', '2023-01-10', 'ADM102F', 'Form Six', 'Tanzania', 'Mara', 'Manasseh Mkumbo', '0711123467', '$2y$10$YourDefaultHashHere', 'Doctor', 'Musoma', 'Mara Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(201, 'S1280-0534', 'Beatrice', 'Reuben', 'Mwanga', 'Female', 'KLF', '2005-12-26', '2023-01-10', 'ADM103F', 'Form Six', 'Tanzania', 'Kagera', 'Reuben Mwanga', '0756123467', '$2y$10$YourDefaultHashHere', 'Engineer', 'Bukoba', 'Kagera Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(202, 'S1280-0540', 'Leticia', 'Simeon', 'Mtepa', 'Female', 'EGM', '2005-04-08', '2023-01-10', 'ADM104F', 'Form Six', 'Tanzania', 'Shinyanga', 'Simeon Mtepa', '0777123467', '$2y$10$YourDefaultHashHere', 'Miner', 'Shinyanga Town', 'Shinyanga Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(203, 'S1280-0554', 'Victoria', 'Levi', 'Mwakalinga', 'Female', 'HLF', '2005-07-21', '2023-01-10', 'ADM105F', 'Form Six', 'Tanzania', 'Geita', 'Levi Mwakalinga', '0712345694', '$2y$10$YourDefaultHashHere', 'Miner', 'Geita Town', 'Geita Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(204, 'S1280-0568', 'Manasseh', 'Judah', 'Mwakalukwa', 'Male', 'HGF', '2005-11-03', '2023-01-10', 'ADM106M', 'Form Six', 'Tanzania', 'Simiyu', 'Judah Mwakalukwa', '0755123472', '$2y$10$YourDefaultHashHere', 'Farmer', 'Bariadi', 'Simiyu Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(205, 'S1280-0509', 'Judah', 'Zebulun', 'Mwagike', 'Male', 'HGE', '2005-02-16', '2023-01-10', 'ADM107M', 'Form Five', 'Tanzania', 'Katavi', 'Zebulun Mwagike', '0777345694', '$2y$10$YourDefaultHashHere', 'Businessman', 'Mpanda', 'Katavi Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(206, 'S1280-0512', 'Zebulun', 'Issachar', 'Mkude', 'Male', 'HGL', '2005-05-30', '2023-01-10', 'ADM108M', 'Form Six', 'Tanzania', 'Njombe', 'Issachar Mkude', '0765123468', '$2y$10$YourDefaultHashHere', 'Teacher', 'Njombe Town', 'Njombe Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL);
INSERT INTO `students` (`id`, `index_number`, `first_name`, `second_name`, `last_name`, `sex`, `combination`, `date_of_birth`, `date_of_admission`, `admission_number`, `class`, `citizenship`, `place_of_birth`, `parent_name`, `parent_phone`, `password`, `parent_occupation`, `parent_residence`, `former_school`, `school_transferred_to`, `date_leaving_school`, `school_transferred_from`, `status`, `created_at`, `updated_at`, `is_leaver`, `year_left`, `previous_class`, `class_changed_at`, `is_returned`, `graduation_status`, `graduation_year`, `promotion_status`, `updated_by_admin`, `failed_login_attempts`, `locked_until`, `last_login_attempt`, `profile_image`, `school_id`, `academic_year`, `teacher_short_note`) VALUES
(207, 'S1280-0521', 'Issachar', 'Gad', 'Mwalongo', 'Male', 'HGK', '2005-09-12', '2023-01-10', 'ADM109M', 'Form Six', 'Tanzania', 'Kigoma', 'Gad Mwalongo', '0789345694', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Kigoma Ujiji', 'Kigoma Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(208, 'S1280-0528', 'Gad', 'Asher', 'Mwandosya', 'Male', 'HKL', '2005-12-25', '2023-01-10', 'ADM110M', 'Form Six', 'Tanzania', 'Rukwa', 'Asher Mwandosya', '0711123468', '$2y$10$YourDefaultHashHere', 'Farmer', 'Sumbawanga', 'Rukwa Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(209, 'S1280-0544', 'Jackline', 'Dan', 'Mtega', 'Female', 'KLF', '2004-04-07', '2022-01-10', 'ADM111F', 'Form Five', 'Tanzania', 'Pemba', 'Dan Mtega', '0756123468', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Chake Chake', 'Pemba Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(210, 'S1280-0557', 'Vivian', 'Naphtali', 'Mwangoka', 'Female', 'EGM', '2004-07-20', '2022-01-10', 'ADM112F', 'Form Five', 'Tanzania', 'Unguja', 'Naphtali Mwangoka', '0777123468', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Zanzibar Town', 'Unguja Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:32', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(211, 'S1280-0567', 'Sylvia', 'Benjamin', 'Mkude', 'Female', 'HLF', '2004-11-02', '2022-01-10', 'ADM113F', 'Form Five', 'Tanzania', 'Dar es Salaam', 'Benjamin Mkude', '0712345695', '$2y$10$YourDefaultHashHere', 'Engineer', 'Kigamboni', 'Kigamboni Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(212, 'S1280-0574', 'Gloria', 'Samuel', 'Mwangosi', 'Female', 'HGF', '2004-02-15', '2022-01-10', 'ADM114F', 'Form Five', 'Tanzania', 'Arusha', 'Samuel Mwangosi', '0755123473', '$2y$10$YourDefaultHashHere', 'Tour Operator', 'Arusha City', 'Arusha Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(214, 'S1280-0519', 'Asher', 'Reuben', 'Mwaibula', 'Male', 'HGL', '2004-09-11', '2022-01-10', 'ADM116M', 'Form Five', 'Tanzania', 'Dodoma', 'Reuben Mwaibula', '0765123469', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(215, 'S1280-0532', 'Naphtali', 'Levi', 'Mwinuka', 'Male', 'HGK', '2004-12-24', '2022-01-10', 'ADM117M', 'Form Five', 'Tanzania', 'Mbeya', 'Levi Mwinuka', '0789345695', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(216, 'S1280-0539', 'Benjamin', 'Judah', 'Mwakapalala', 'Male', 'HKL', '2004-04-06', '2022-01-10', 'ADM118M', 'Form Five', 'Tanzania', 'Tanga', 'Judah Mwakapalala', '0711123469', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
...
(218, 'S1280-0565', 'Solomon', 'Gad', 'Mkumbo', 'Male', 'EGM', '2004-11-01', '2022-01-10', 'ADM120M', 'Form Five', 'Tanzania', 'Mwanza', 'Gad Mkumbo', '0777123469', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ilemela, Mwanza', 'Mwanza Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(219, 'S1280-0548', 'Flora', 'Asher', 'Mwagikana', 'Female', 'HLF', '2005-02-14', '2023-01-10', 'ADM121F', 'Form Six', 'Tanzania', 'Arusha', 'Asher Mwagikana', '0712345696', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha City', 'Arusha Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(220, 'S1280-0562', 'Linda', 'Naphtali', 'Mkumbo', 'Female', 'HGF', '2005-05-28', '2023-01-10', 'ADM122F', 'Form Six', 'Tanzania', 'Moshi', 'Naphtali Mkumbo', '0755123474', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(221, 'S1280-0503', 'Tatu', 'Joseph', 'Mwakalukwa', 'Female', 'HGE', '2005-09-10', '2023-01-10', 'ADM123F', 'Form Six', 'Tanzania', 'Dar es Salaam', 'Joseph Mwakalukwa', '0777345696', '$2y$10$YourDefaultHashHere', 'Businessman', 'Kinondoni', 'Kinondoni Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(222, 'S1280-0508', 'Mwajuma', 'Dan', 'Mkumbo', 'Female', 'HGL', '2005-12-23', '2023-01-10', 'ADM124F', 'Form Six', 'Tanzania', 'Zanzibar', 'Dan Mkumbo', '0765123470', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Stone Town', 'Zanzibar Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(223, 'S1280-0519', 'Zawadi', 'Zebulun', 'Mtepa', 'Female', 'HGK', '2005-04-05', '2023-01-10', 'ADM125F', 'Form Six', 'Tanzania', 'Tanga', 'Zebulun Mtepa', '0789345696', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tanga City', 'Tanga Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(224, 'S1280-0532', 'Reuben', 'Issachar', 'Mwangoka', 'Male', 'HKL', '2005-07-18', '2023-01-10', 'ADM126M', 'Form Six', 'Tanzania', 'Iringa', 'Issachar Mwangoka', '0711123470', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Iringa Municipality', 'Iringa Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(225, 'S1280-0537', 'Levi', 'Benjamin', 'Mkinda', 'Male', 'KLF', '2005-10-31', '2023-01-10', 'ADM127M', 'Form Six', 'Tanzania', 'Songwe', 'Benjamin Mkinda', '0756123470', '$2y$10$YourDefaultHashHere', 'Businessman', 'Vwawa', 'Songwe Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(226, 'S1280-0544', 'Judah', 'Manasseh', 'Mwakasaka', 'Male', 'EGM', '2005-02-13', '2023-01-10', 'ADM128M', 'Form Six', 'Tanzania', 'Tabora', 'Manasseh Mwakasaka', '0777123470', '$2y$10$YourDefaultHashHere', 'Teacher', 'Tabora Municipality', 'Tabora Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(227, 'S1280-0557', 'Simeon', 'Ephraim', 'Mngumi', 'Male', 'HLF', '2005-05-27', '2023-01-10', 'ADM129M', 'Form Six', 'Tanzania', 'Singida', 'Ephraim Mngumi', '0712345697', '$2y$10$YourDefaultHashHere', 'Nurse', 'Singida Town', 'Singida Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(228, 'S1280-0565', 'Gad', 'Manasseh', 'Mkumbo', 'Male', 'HGF', '2005-09-09', '2023-01-10', 'ADM130M', 'Form Six', 'Tanzania', 'Mara', 'Manasseh Mkumbo', '0755123475', '$2y$10$YourDefaultHashHere', 'Doctor', 'Musoma', 'Mara Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(230, 'S1280-0514', 'Anita', 'Simeon', 'Mtepa', 'Female', 'HGL', '2004-04-04', '2022-01-10', 'ADM132F', 'Form Five', 'Tanzania', 'Shinyanga', 'Simeon Mtepa', '0765123471', '$2y$10$YourDefaultHashHere', 'Miner', 'Shinyanga Town', 'Shinyanga Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(231, 'S1280-0526', 'Judith', 'Levi', 'Mwakalinga', 'Female', 'HGK', '2004-07-17', '2022-01-10', 'ADM133F', 'Form Five', 'Tanzania', 'Geita', 'Levi Mwakalinga', '0789345697', '$2y$10$YourDefaultHashHere', 'Miner', 'Geita Town', 'Geita Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:29', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(232, 'S1280-0535', 'Martha', 'Judah', 'Mwakalukwa', 'Female', 'HKL', '2004-10-30', '2022-01-10', 'ADM134F', 'Form Five', 'Tanzania', 'Simiyu', 'Judah Mwakalukwa', '0711123471', '$2y$10$YourDefaultHashHere', 'Farmer', 'Bariadi', 'Simiyu Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:30', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(233, 'S1280-0543', 'Esther', 'Zebulun', 'Mwagike', 'Female', 'KLF', '2004-02-12', '2022-01-10', 'ADM135F', 'Form Five', 'Tanzania', 'Katavi', 'Zebulun Mwagike', '0756123471', '$2y$10$YourDefaultHashHere', 'Businesswoman', 'Mpanda', 'Katavi Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:31', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(234, 'S1280-0559', 'Dan', 'Issachar', 'Mkude', 'Male', 'EGM', '2004-05-26', '2022-01-10', 'ADM136M', 'Form Five', 'Tanzania', 'Njombe', 'Issachar Mkude', '0777123471', '$2y$10$YourDefaultHashHere', 'Teacher', 'Njombe Town', 'Njombe Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:33', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(235, 'S1280-0572', 'Zebulun', 'Gad', 'Mwalongo', 'Male', 'HLF', '2004-09-08', '2022-01-10', 'ADM137M', 'Form Five', 'Tanzania', 'Kigoma', 'Gad Mwalongo', '0712345698', '$2y$10$YourDefaultHashHere', 'Fisherman', 'Kigoma Ujiji', 'Kigoma Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(236, 'S1280-0577', 'Issachar', 'Asher', 'Mwandosya', 'Male', 'HGF', '2004-12-21', '2022-01-10', 'ADM138M', 'Form Five', 'Tanzania', 'Rukwa', 'Asher Mwandosya', '0755123476', '$2y$10$YourDefaultHashHere', 'Farmer', 'Sumbawanga', 'Rukwa Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:34', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(237, 'S1280-0507', 'Gad', 'Dan', 'Mtega', 'Male', 'HGE', '2004-04-03', '2022-01-10', 'ADM139M', 'Form Five', 'Tanzania', 'Pemba', 'Dan Mtega', '0765123472', '$2y$10$YourDefaultHashHere', 'Businessman', 'Chake Chake', 'Pemba Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:27', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(238, 'S1280-0520', 'Asher', 'Naphtali', 'Mwangoka', 'Male', 'HGL', '2004-07-16', '2022-01-10', 'ADM140M', 'Form Five', 'Tanzania', 'Unguja', 'Naphtali Mwangoka', '0789345698', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Zanzibar Town', 'Unguja Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(239, 'S1280-0517', 'Paulina', 'Benjamin', 'Mkude', 'Female', 'HGK', '2005-10-29', '2023-01-10', 'ADM141F', 'Form Six', 'Tanzania', 'Dar es Salaam', 'Benjamin Mkude', '0711123472', '$2y$10$YourDefaultHashHere', 'Engineer', 'Kigamboni', 'Kigamboni Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:37', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(240, 'S1280-0526', 'Salome', 'Samuel', 'Mwangosi', 'Female', 'HKL', '2005-02-11', '2023-01-10', 'ADM142F', 'Form Six', 'Tanzania', 'Arusha', 'Samuel Mwangosi', '0756123472', '$2y$10$YourDefaultHashHere', 'Tour Operator', 'Arusha City', 'Arusha Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(241, 'S1280-0535', 'Rehema', 'Solomon', 'Mkuchika', 'Female', 'KLF', '2005-05-25', '2023-01-10', 'ADM143F', 'Form Six', 'Tanzania', 'Moshi', 'Solomon Mkuchika', '0777123472', '$2y$10$YourDefaultHashHere', 'Hotel Manager', 'Moshi Rural', 'Moshi Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(242, 'S1280-0542', 'Pili', 'Reuben', 'Mwaibula', 'Female', 'EGM', '2005-09-07', '2023-01-10', 'ADM144F', 'Form Six', 'Tanzania', 'Dodoma', 'Reuben Mwaibula', '0712345699', '$2y$10$YourDefaultHashHere', 'Civil Servant', 'Dodoma City', 'Dodoma Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(243, 'S1280-0553', 'Sijali', 'Levi', 'Mwinuka', 'Female', 'HLF', '2005-12-20', '2023-01-10', 'ADM145F', 'Form Six', 'Tanzania', 'Mbeya', 'Levi Mwinuka', '0755123477', '$2y$10$YourDefaultHashHere', 'Teacher', 'Mbeya City', 'Mbeya Girls', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:39', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(244, 'S1280-0569', 'Naphtali', 'Judah', 'Mwakapalala', 'Male', 'HGF', '2005-04-02', '2023-01-10', 'ADM146M', 'Form Six', 'Tanzania', 'Tanga', 'Judah Mwakapalala', '0765123473', '$2y$10$YourDefaultHashHere', 'Businessman', 'Tanga City', 'Tanga Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:40', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(246, 'S1280-0511', 'Samuel', 'Gad', 'Mkumbo', 'Male', 'HGL', '2005-10-28', '2023-01-10', 'ADM148M', 'Form Six', 'Tanzania', 'Mwanza', 'Gad Mkumbo', '0711123473', '$2y$10$YourDefaultHashHere', 'Engineer', 'Ilemela, Mwanza', 'Mwanza Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(247, 'S1280-0523', 'Solomon', 'Asher', 'Mwagikana', 'Male', 'HGK', '2005-02-10', '2023-01-10', 'ADM149M', 'Form Six', 'Tanzania', 'Arusha', 'Asher Mwagikana', '0756123473', '$2y$10$YourDefaultHashHere', 'Tour Guide', 'Arusha City', 'Arusha Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(248, 'S1280-0531', 'Reuben', 'Naphtali', 'Mkumbo', 'Male', 'HKL', '2005-05-24', '2023-01-10', 'ADM150M', 'Form Six', 'Tanzania', 'Moshi', 'Naphtali Mkumbo', '0777123473', '$2y$10$YourDefaultHashHere', 'Hotel Owner', 'Moshi Municipality', 'Moshi Boys', NULL, NULL, NULL, 1, '2026-01-08 12:34:32', '2026-06-22 17:51:38', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(250, 'S1280-0510', 'laurent', 'jumanne', 'tadeo', 'Male', 'HGE', '2005-02-23', '2026-01-23', '12348s', 'Form Five', 'Tanzania', 'KIGOMA', 'JUMANNE TAZE', '255745607567', '$2y$10$YourDefaultHashHere', '', 'KIGOMA', '', '', '0000-00-00', '', 1, '2026-01-23 16:12:49', '2026-06-22 17:51:28', 0, NULL, NULL, '2026-04-21 10:15:14', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, NULL, NULL, 1, '2025/2026', NULL),
(251, 'S1280-0504', 'tazan ', 'samsin', 'thazan', 'Male', 'HGE', '2021-05-07', '2026-02-07', 'e444', 'Form Six', 'Tanzania', 'kg', 'clemensia samson', '255619844080', '$2y$10$h4t5q//WxVXQDp00.TIRV.jYanT0ln.sdemzjFzeuJ0mcLADPHy56', 'teacher', 'uvinza', '', '', '0000-00-00', '', 1, '2026-02-07 17:17:01', '2026-06-22 17:51:36', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 1, 'Form Five', NULL, 'Promoted to Form Six', 32, 1, NULL, '2026-04-03 20:57:32', NULL, 1, '2025/2026', NULL),
(409, 'S1280-0501', 'princess', 'toy', 'toy', 'Female', 'HGE', '2016-05-08', '2026-03-27', 'y78', 'Form Six', 'Tanzania', 'kigoma', 'usa', '255619844080', '$2y$10$XqDSXRgczVpT5K8rBd3OTePIX.3tDrNNbceSDENENuGLjysyaepS.', 'engineer', 'dar', '', '', '0000-00-00', '', 1, '2026-03-27 10:12:05', '2026-06-22 17:51:34', 0, NULL, 'Form Five', '2026-04-21 19:50:26', 0, 'Form Five', NULL, 'Promoted to Form Six', 32, 0, NULL, '2026-03-27 13:12:53', NULL, 1, '2025/2026', NULL);
...
INSERT INTO `teacher_class_assignments` (`id`, `teacher_id`, `class_level`, `combination`, `assigned_by`, `assigned_at`, `updated_at`, `school_id`) VALUES
(1, 26, 'Form Five', 'HGE', 32, '2026-06-23 07:45:52', '2026-06-23 08:15:29', 1),
(3, 26, 'Form Six', 'HGL', 32, '2026-06-23 08:15:46', '2026-06-23 08:15:46', 1),
(4, 14, 'Form Five', 'HGK', 32, '2026-06-23 08:16:49', '2026-06-23 08:16:49', 1);
...
ALTER TABLE `attendance_records`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_student_attendance` (`student_id`,`attendance_date`,`school_id`),
  ADD KEY `idx_student_id` (`student_id`),
  ADD KEY `idx_teacher_id` (`teacher_id`),
  ADD KEY `idx_class_combination` (`class_level`,`combination`),
...
ALTER TABLE `fee_settings`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_school_year` (`school_id`,`academic_year`),
...
--
-- Indexes for table `generated_timetables`
--
ALTER TABLE `generated_timetables`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_timetable` (`term`,`year`,`school_id`),
  ADD KEY `idx_school_id` (`school_id`),
...
ALTER TABLE `holiday_packages`
  ADD PRIMARY KEY (`id`),
  ADD KEY `subject` (`subject`,`form_level`);
...
ALTER TABLE `teacher_class_assignments`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_teacher_class_combination` (`teacher_id`,`class_level`,`combination`,`school_id`),
  ADD KEY `idx_teacher_id` (`teacher_id`),
  ADD KEY `idx_class_combination` (`class_level`,`combination`),
  ADD KEY `idx_school_id` (`school_id`),
  ADD KEY `assigned_by` (`assigned_by`);
