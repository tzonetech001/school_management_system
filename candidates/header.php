...
<body>
            ...
            <div class="row align-items-center h-100">
                ...
                <div class="col-8 col-md-3">
                    <div class="user-profile-compact">
                        ...
                        if ($is_admin) {
                            // Get admin info from session and database
                            ...
                            if ($user) {
                                ...
                                $user_type = 'admin';
                                $dashboard_link = '../controller/dashboard.php';
                                $profile_link = '../profile/profile.php';
                                $logout_link = '../profile/logout.php';
                            }
                        } elseif ($is_student) {
                            ...
                            if ($student) {
                                ...
                                $user_primary_role = 'Student';
                                $user_roles = 'Student - ' . $user_class . ' ' . $user_combination;
                                $user_type = 'student';
                                $dashboard_link = '../candidates/dashboard.php';
                                $profile_link = '../candidates/profile.php';
                                $logout_link = '../candidates/logout.php';
                            }
                        }
                        ?>
                        
                        <!-- Role Display -->
                        <div class="user-role-display" title="<?php echo htmlspecialchars($user_roles ?? 'User'); ?>">
                            <?php echo htmlspecialchars($user_primary_role ?? 'User'); ?>
                        </div>
                        
                        <!-- User Avatar with Dropdown -->
                        <div class="user-avatar-dropdown">
                            <div class="user-avatar-small <?php echo !empty($profile_image_url) ? 'has-image' : ''; ?>" 
                                 id="userAvatar">
                            ...
                            <div class="user-dropdown-menu" id="userDropdown">
                                <div class="user-dropdown-header">
                                    <div class="user-dropdown-avatar <?php echo !empty($profile_image_url) ? 'has-image' : ''; ?>">
                                        <?php if (!empty($profile_image_url)): ?>
                                            <img src="<?php echo $profile_image_url; ?>" alt="Profile">
                                        <?php else: ?>
                                            <?php echo $initials ?? 'U'; ?>
                                    ...
                                    <div class="user-dropdown-name"><?php echo htmlspecialchars($full_name ?? 'User'); ?></div>
                                    <div class="user-dropdown-role"><?php echo htmlspecialchars($user_primary_role ?? 'User'); ?></div>
                                </div>
                                ...
                                <div class="user-dropdown-body">
                                    <?php if ($is_admin): ?>
                                        ...
                                        <div class="user-info-item">
                                            ...
                                            <div class="user-info-content">
                                                <div class="user-info-label">NIDA</div>
                                                <div class="user-info-value"><?php echo htmlspecialchars($user_nida ?: 'Not provided'); ?></div>
                                            </div>
                                        </div>
                                    ...
                                    <?php else: ?>
                                        ...
                                        <div class="user-info-item">
                                            ...
                                            <div class="user-info-content">
                                                <div class="user-info-label">Admission Number</div>
                                                <div class="user-info-value"><?php echo htmlspecialchars($user_admission); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="user-info-item">
                                            ...
                                            <div class="user-info-content">
                                                <div class="user-info-label">Class</div>
                                                <div class="user-info-value"><?php echo htmlspecialchars($user_class . ' ' . $user_combination); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="user-info-item">
                                            ...
                                            <div class="user-info-content">
                                                <div class="user-info-label">Email</div>
                                                <div class="user-info-value"><?php echo htmlspecialchars($user_email ?: 'Not provided'); ?></div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="user-info-item">
                                            ...
                                            <div class="user-info-content">
                                                <div class="user-info-label">Phone</div>
                                                <div class="user-info-value"><?php echo htmlspecialchars($user_phone ?: 'Not provided'); ?></div>
                                            </div>
                                        </div>
                                    <?php endif; ?>
                                    ...
                                    <div class="user-info-item">
                                        ...
                                        <div class="user-info-content">
                                            ...
                                            <div class="user-info-value">
                                                <span class="badge <?php echo ($user_status ?? 1) ? 'bg-success' : 'bg-danger'; ?>">
                                                    <?php echo ($user_status ?? 1) ? 'Active' : 'Inactive'; ?>
                                                </span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="user-dropdown-footer">
                                    <a href="<?php echo $profile_link; ?>" class="btn-profile">
                                        <i class="fas fa-user-cog me-1"></i>Profile
                                    </a>
                                    <a href="<?php echo $logout_link; ?>" class="btn-logout">
            ...
            if (window.innerWidth < 992) {
                ...
                if (mainContent) {
                    if (sidebar.classList.contains('active')) {
                        ...
                        mainContent.classList.remove('sidebar-open-full');
                    }
                }
                if (sidebar.classList.contains('active')) {
    ...
    // Function to update user avatar when profile image changes
    function updateUserAvatar(imageUrl) {
        ...
        if (avatarSmall) {
            if (imageUrl) {
                avatarSmall.innerHTML = `<img src="${imageUrl}" alt="Profile">`;
                avatarSmall.classList.add('has-image');
            } else {
                avatarSmall.innerHTML = avatarSmall.dataset.initials || 'U';
        ...
        if (avatarLarge) {
            if (imageUrl) {
                avatarLarge.innerHTML = `<img src="${imageUrl}" alt="Profile">`;
                avatarLarge.classList.add('has-image');
            } else {
                avatarLarge.innerHTML = avatarLarge.dataset.initials || 'U';
