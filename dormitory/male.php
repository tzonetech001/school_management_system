...
function removeLeaversFromDormitories($conn) {
    ...
    if ($leavers_result && mysqli_num_rows($leavers_result) > 0) {
        ...
        if ($removed_count > 0) {
            $_SESSION['info'] = "Automatically removed $removed_count leaver/graduated male students from dormitories.";
        }
    }
...
$male_result = mysqli_query($conn, $male_students_sql);
$male_students = [];
if ($male_result && mysqli_num_rows($male_result) > 0) {
    while ($row = mysqli_fetch_assoc($male_result)) {
        $male_students[] = $row;
    }
}
...
$total_unassigned = $total_male_students - $total_assigned;
...
<div class="main-content">
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h2 class="page-title">Male Dormitory Management</h2>
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stats-card simple-card">
                    ...
                    <h3><?php echo $total_male_students; ?></h3>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stats-card simple-card">
                    <div class="stats-icon">
                        <i class="fas fa-bed" style="color: #007bff;"></i>
                    </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stats-card simple-card">
                    ...
                    <p>Available Beds</p>
                    <small class="text-muted">Across all male dormitories</small>
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 mb-3">
                <div class="stats-card simple-card">
                    <div class="stats-icon">
                        <i class="fas fa-user-times" style="color: #007bff;"></i>
                    </div>
            ...
            <form method="POST" action="">
                <div class="modal-body">
                    ...
                    <div class="alert alert-info">
                        ...
                        <strong>Male Dormitory Capacities:</strong>
                        <div class="row mt-2">
                            <div class="col-md-6">
                                <ul class="mb-2">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    removeButtons.forEach(button => {
        button.addEventListener('click', function() {
            ...
            document.getElementById('confirmRemove').href = `male.php?remove_assignment=${assignmentId}`;
...
<style>
/* MALE DORMITORY PAGE SPECIFIC STYLES */
.avatar-circle {
    width: 40px;
    height: 40px;
    border-radius: 50%;
