...
// Create the display name with title + first name + last name
            ...
            <div class="row align-items-center h-100 g-0">
                ...
                <div class="col-4 col-sm-4 col-md-3">
                    <div class="logo-container">
                        ...
                        ?>
                        <div class="school-name d-none d-sm-block"> SCHOOL SYSTEM</div>
                ...
                <div class="col-md-6 d-none d-md-flex justify-content-center">
                    <div class="school-center text-center">
                        <div class="school-main-name">School Management System</div>
                ...
                <div class="col-8 col-sm-8 col-md-3">
                    <div class="user-profile-compact">
                        ...
                        <div class="left-header-items">
                            ...
                            <!-- User Name Display - Mr./Ms. + First Name + Last Name (replacing role) -->
