<?php
// search_students.php - AJAX endpoint for student search in fee module
session_start();
...
// Build search query WITH school_id filtering (same as discipline/search_students.php)
